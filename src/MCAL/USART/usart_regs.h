...
typedef struct
{
  volatile uint32 SR;         /*!< USART Status register,                   Address offset: 0x00 */
  volatile uint32 DR;         /*!< USART Data register,                     Address offset: 0x04 */
  volatile uint32 BRR;        /*!< USART Baud rate register,                Address offset: 0x08 */
  volatile uint32 CR1;        /*!< USART Control register 1,                Address offset: 0x0C */
  volatile uint32 CR2;        /*!< USART Control register 2,                Address offset: 0x10 */
  volatile uint32 CR3;        /*!< USART Control register 3,                Address offset: 0x14 */
  volatile uint32 GTPR;       /*!< USART Guard time and prescaler register, Address offset: 0x18 */
} USART_RegStruct;
/********/
...
#define UART_DIV_SAMPLING16(_PCLK_, _BAUD_)            ((uint32)((((uint64)(_PCLK_))*25U)/(4U*((uint64)(_BAUD_)))))
